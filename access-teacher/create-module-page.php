...
logUserHistory("visited", "Create Module"); // You can customize this per page
...
<body>
    ...
    <div class="main-content">
        ...
        <!-- Create Module Form -->
        <div class="form-card">
            <form action="functions/create-module" method="POST">
                <input type="hidden" name="course_id" value="<?= $course_id ?>">

                <h3 class="form-header">New Module</h3>

                <div class="form-group">
                    <label for="module_number">Module Number</label>
                    <input type="text" name="module_number" id="module_number" class="form-control" required>
                </div>
