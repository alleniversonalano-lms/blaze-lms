...
.unread-count {
        ...
        .poll-card .form-group {
            margin-bottom: 1rem;
        }

        .poll-card .form-control {
            width: 100%;
            padding: 8px 12px;
            border: 1px solid #ccc;
            border-radius: 8px;
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="section-nav" style="margin-top: 20px; border-bottom: 2px solid #ccc; padding-bottom: 10px;">
            <a href="create-announcement-page" class="section-tab" style="text-decoration: none; color: #333;">Threads</a>
            <a href="create-poll" class="section-tab active" style="margin-left: 20px; text-decoration: none; font-weight: bold; color: #6c1d45;">Poll</a>
        </div>
        ...
        <div class="card poll-card">
            <div class="card-body">
                ...
                <form method="POST" action="functions/polls">
                    <input type="hidden" name="course_id" value="<?= htmlspecialchars($course_id) ?>">

                    <div class="form-group mb-3">
                        <label for="poll-question" class="form-label">Question</label>
                        <textarea name="question" id="poll-question" class="form-control" rows="3" maxlength="250" required></textarea>
                    </div>
