...
<body>
    ...
    <div style="margin-bottom: 20px; text-align: right;">
        <button onclick="window.location.href='assessments'" class="floating-exit-btn" id="floatingExitBtn" style="padding: 8px 16px;">
            ← Exit Preview
        </button>
    </div>
    ...
    <div class="container">
        ...
        <div class="tabs">
            <button class="tab" onclick="showTab('settings')" disabled style="cursor: not-allowed; opacity: 0.5;">Settings</button>
            <button class="tab" onclick="showTab('questions')" disabled style="cursor: not-allowed; opacity: 0.5;">Questions</button>
...
document.head.appendChild(styleSheet);
    ...
    if (question.formula && Object.keys(question.variables || {}).length > 0) {
        ...
        function updatePreview() {
            ...
            let html = `
            <div style="margin-bottom: 20px; text-align: right;">
                <button onclick="window.location.href='assessments'" class="btn btn-outline" style="padding: 8px 16px;">
                    ← Exit Preview
                </button>
            </div>
