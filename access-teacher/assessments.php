            ...
            async function loadAssessments() {
                ...
                try {
                    ...
                    data.forEach(assess => {
                        ...
                        const date = new Date(safeAssess.created_at);
                        // Convert to PH time by adding 8 hours (UTC+8)
                        const phDate = new Date(date.getTime() + (8 * 60 * 60 * 1000));
                        const postedAt = phDate.toLocaleString('en-US', {
                            month: 'long',
                            day: 'numeric',
                            year: 'numeric',
                            hour: 'numeric',
                        ...
                        card.innerHTML = `
                            <div class="card-header">
                                <div>
                                    ...
                                    <p class="assessment-meta">Posted on: ${postedAt} (PHT)</p>
                                    <div style="display: flex; gap: 8px; margin-top: 4px;">
                                        <span class="badge ${parseInt(safeAssess.is_published) === 1 ? 'badge-published' : 'badge-draft'}" title="${parseInt(safeAssess.is_published) === 1 ? 'Quiz is visible to students' : 'Quiz is hidden from students'}">
                                            <i class="fas fa-${parseInt(safeAssess.is_published) === 1 ? 'eye' : 'eye-slash'}"></i>
                                            ${parseInt(safeAssess.is_published) === 1 ? 'Published' : 'Unpublished'}
                                        </span>
                                ...
                                <div class="menu-container">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="#" class="menu-item publish-btn" data-id="${safeAssess.id}" data-status="${parseInt(safeAssess.is_published) === 1 ? '1' : '0'}">
                                            <i class="fas fa-${parseInt(safeAssess.is_published) === 1 ? 'eye-slash' : 'eye'}"></i>
                                            ${parseInt(safeAssess.is_published) === 1 ? 'Unpublish' : 'Publish'}
                                        </a>
                            ...
                            <div class="card-body">
                                ...
                                <form action="view-assessment" method="GET" style="margin-top: 12px;">
