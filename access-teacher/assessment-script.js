...
function renderMultipleChoiceEditor(questionData) {
    return `
        <div class="form-group">
            ...
            <div class="math-syntax-help">
                <div class="math-syntax-title">Math Syntax Guide:</div>
                <div class="math-syntax-examples">
                    <code>^2</code> → x² (superscript)
                    <code>_2</code> → x₂ (subscript)
                    <code>(1/2)</code> → ½ (fraction)
                    <code>sqrt(x)</code> → √x
                    <code>pi</code> → π
                    <code>theta</code> → θ
                    <code>delta</code> → Δ
