...
logUserHistory("visited", "Create Bulletin Feed"); // You can customize this per page
...
.unread-count {
        ...
        .announcement-form {
            ...
            /* Remove 'auto' for left alignment */
            background: #fff;
            border-radius: 8px;
            padding: 30px;
...
<body>
    ...
    <div class="main-content">
        ...
        <h2>Create Bulletin Feed</h2>

        <br>

        <!-- Custom Navbar -->
        <!-- Section Navigation (Threads | Polls) -->
        <div class="section-nav" style="margin-top: 20px; border-bottom: 2px solid #ccc; padding-bottom: 10px;">
            <a href="create-announcement-page" class="section-tab active" style="margin-right: 20px; text-decoration: none; font-weight: bold; color: #6c1d45;">Threads</a>
            <a href="create-poll" class="section-tab" style="text-decoration: none; color: #333;">Poll</a>
        </div>

        <!-- Page content goes here -->
        <div class="announcement-form">
            <form id="announcementForm" action="functions/create-announcement" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="course_id" value="<?= htmlspecialchars($course_id) ?>">
                <input type="hidden" name="user_id" value="<?= $_SESSION['user_id'] ?>">

                <div class="form-group">
                    <label for="description">Description</label>
                    <textarea name="description" id="description" required placeholder="Type your announcement here..."></textarea>
                </div>

                <div class="form-group">
                    <label for="attachments">
                        Attachments <span style="color: #888; font-size: x-small">(Optional)</span>
                    </label>
