...
<body>
    ...
    <div class="main-content">
        ...
        <div class="nav-button">
            <a href="create-course-page" class="nav-btn">Create Course</a>
        </div>
        ...
        <div class="course-grid">
            ...
            $stmt = $conn->prepare("SELECT * FROM courses WHERE user_id = ? AND published = 1 ORDER BY created_at DESC");
            $stmt->bind_param("i", $user_id);
            $stmt->execute();
            $result = $stmt->get_result();
                            ...
                            <div class="card-header">
                                ...
                                <div class="menu-container">
                                    ...
                                    <div class="dropdown-menu">
                                        <form action="edit-course-page" method="POST" style="margin: 0;">
                                        ...
                                        <form action="functions/unpublish-course" method="POST" style="margin: 0;">
                                            <input type="hidden" name="course_id" value="<?= $course['id'] ?>">
                                            <button type="submit" style="background: none; border: none; padding: 10px 14px; width: 100%; text-align: left; cursor: pointer;">
                                                Unpublish
                                            </button>
                                        ...
                                        <form action="functions/delete-course" method="POST" onsubmit="return confirmDeleteCourse();" style="margin: 0;">
                                            <input type="hidden" name="course_id" value="<?= $course['id'] ?>">
                                            <button type="submit" style="background: none; border: none; padding: 10px 14px; width: 100%; text-align: left; cursor: pointer;">
                                                Delete
                                            </button>
            ...
            <?php else: ?>
                <p style="text-align:center; color:#999; margin-top:40px;">No courses found.</p>
            <?php endif; ?>
