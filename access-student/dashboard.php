...
<body>
    ...
    <div class="main-content">
        ...
        // Get student courses (adjust table name if different)
        $stmt = $conn->prepare("
        SELECT 
            c.*, 
        ...
        WHERE ce.student_id = ? AND c.published = 1
    ...
    ");
                ...
                <?php while ($course = $result->fetch_assoc()): ?>
                    <div class="course-card">
                        <div class="card-header">
                            ...
                            <!-- Removed menu-container for students -->
                        </div>
        ...
        <?php else: ?>
            <p style="text-align:center; color:#999; margin-top:40px;">You have not joined any classes yet.</p>
        <?php endif; ?>
