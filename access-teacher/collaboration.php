...
<body>
    ...
    <div class="main-content">
        ...
        <form action="functions/join-course" method="POST" style="margin-bottom: 30px; max-width: 400px;">
            <label for="class_code" style="font-weight: bold; margin-bottom: 10px; display: block;">Join a Course</label>
            <input type="text" name="class_code" id="class_code" placeholder="Enter class code (case-sensitive)" required
                style="width: 100%; padding: 10px; font-size: 1rem; border-radius: 6px; border: 1px solid #ccc;">
            <button type="submit"
                style="margin-top: 10px; background-color: #B71C1C; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer;">
                Join
            </button>
        </form>
    ...
    WHERE cc.teacher_id = ? AND c.published = 1
...
");
                    ...
                    <div class="course-card">
                        <div class="card-header">
                            <div>
                                ...
                                <p class="meta">Instructor:
                                    <strong><?= htmlspecialchars($course['instructor_first'] . ' ' . $course['instructor_last']) ?></strong>
                                </p>
                            ...
                            <div class="menu-container">
                                ...
                                <div class="dropdown-menu">
                                    <form action="functions/leave-course" method="POST" style="margin: 0;">
        ...
        <?php else: ?>
            <p style="text-align:center; color:#999; margin-top:40px;">You have not joined any courses as a co-teacher.</p>
        <?php endif; ?>
